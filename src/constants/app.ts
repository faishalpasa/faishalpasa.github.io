...
export const REPEATED_TEXT_SPEED = 75
export const TEXTS = ['Hi, I\'m Faishal Pasa', ' (Uje)', 'I\'m a software developer with +10 years of experience. I build ']
export const REPEATED_TEXTS = ['web application', 'mobile application', 'games', 'anythings using code.']
