...
const SKILLS = [
  {
    category: 'Web',
    items: ['HTML/CSS', 'JavaScript', 'TypeScript', 'React', 'Next.js', 'PHP', 'Laravel'],
  },
  {
    category: 'Mobile',
    items: ['React Native'],
...
const PORTFOLIOS = [
  ...
  },
  {
    ...
    description: 'Project game web yang agak serius. Awalnya cuma pengen bikin game kayak dino chrome bertema mario bros. Lahirlah game parody: Tjoean Run.',
    link: 'https://www.linkedin.com/feed/update/urn:li:activity:7199740945905430528/',
  },
  {
    imgSrc: '/images/portfolio-3.jpeg',
    description: 'Ngebuat story ala instagram untuk campaign Ramadan 2024 Bareksa dengan isi konten yang dinamis dan animasi CSS.',
    link: 'https://www.linkedin.com/feed/update/urn:li:activity:7176895408705601536/',
  },
  {
    imgSrc: '/images/portfolio-4.jpeg',
    description: 'Mini game bendera — terinspirasi dari pengalaman jadi petugas pengibar bendera. Untuk memperingati hari kemerdekaan Indonesia ke-78.',
    link: 'https://www.linkedin.com/feed/update/urn:li:activity:7097599814149836800/',
  },
  {
    imgSrc: '/images/portfolio-5.jpeg',
    description: 'Game puzzle simple untuk anak. Bosen dengan satu set, tinggal ganti image-nya. Alhamdulillah lolos QA oleh anak sendiri.',
    link: 'https://www.linkedin.com/feed/update/urn:li:activity:7036945722738446337/',
  },
  {
    imgSrc: '/images/portfolio-6.jpeg',
    description: 'Spotify Top List — terinspirasi dari viral "Spotify Pie". Dibuat pakai Spotify API untuk menampilkan top tracks & artists.',
    link: 'https://www.linkedin.com/feed/update/urn:li:activity:6941187905872621568/',
  },
  {
    imgSrc: '/images/portfolio-7.jpeg',
    description: 'Mini game puzzle buah, mobile responsive dengan custom hook. Buahnya bisa beli di TaniHub haha.',
  ...
  },
  {
    ...
    description: 'Full keyboard Keychron K2 dibuat dengan CSS, lengkap dengan efek backlight dan typing animation.',
    link: 'https://www.linkedin.com/feed/update/urn:li:activity:6878589670150819840/',
  },
  {
    imgSrc: '/images/portfolio-10.jpeg',
    description: 'Game card match — hasil dari kebosanan ngerjain tech debt akhir 2020. Dibuat dengan React hook dan local storage.',
...
const SOCIALS = [
  ...
  },
  {
    ...
    label: 'GitHub',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 496 512" className="w-5 h-5">
        ...
        <section className="py-20">
          ...
          >
            ...
            <h1 className="text-4xl font-bold tracking-tight mb-2">
              Faishal Pasa
              <span className="text-gray-400 dark:text-gray-500 font-normal"> (Uje)</span>
            </h1>
            <p className="text-lg text-gray-500 dark:text-gray-400 mt-4 leading-relaxed">
              ...
              I build web apps, mobile apps, and games.
            </p>
        ...
        <section className="py-16">
          <motion.div {...fadeUp}>
            ...
            <div className="space-y-6">
              {SKILLS.map((group) => (
                <div key={group.category} className="flex flex-col sm:flex-row gap-2 sm:gap-8">
